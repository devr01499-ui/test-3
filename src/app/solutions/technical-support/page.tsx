...
import { technicalSupportData } from "@/data/solutions/technical-support";

export const metadata: Metadata = {
  title: technicalSupportData.title,
  description: technicalSupportData.description,
};

export default function TechnicalSupportPage() {
  const data = technicalSupportData;
  return (
