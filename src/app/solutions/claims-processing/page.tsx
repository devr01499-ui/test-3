...
import { claimsProcessingData } from "@/data/solutions/claims-processing";

export const metadata: Metadata = {
  title: claimsProcessingData.title,
  description: claimsProcessingData.description,
};

export default function ClaimsProcessingPage() {
  const data = claimsProcessingData;
  return (
