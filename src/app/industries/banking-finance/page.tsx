...
import { bankingFinanceData } from "@/data/industries/banking-finance";

export const metadata: Metadata = {
  title: bankingFinanceData.title,
  description: bankingFinanceData.description,
};

export default function BankingFinancePage() {
  const data = bankingFinanceData;
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Trust Your Financial Operations to the Experts</h2>
