...
import { mediaEntertainmentData } from "@/data/industries/media-entertainment";

export const metadata: Metadata = {
  title: mediaEntertainmentData.title,
  description: mediaEntertainmentData.description,
};

export default function MediaEntertainmentPage() {
  const data = mediaEntertainmentData;
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Engage Audiences. Scale Content. Protect Your Platform.</h2>
