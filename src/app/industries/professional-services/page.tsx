...
import { professionalServicesData } from "@/data/industries/professional-services";

export const metadata: Metadata = {
  title: professionalServicesData.title,
  description: professionalServicesData.description,
};

export default function ProfessionalServicesPage() {
  const data = professionalServicesData;
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Focus on Client Value. We Handle the Rest.</h2>
