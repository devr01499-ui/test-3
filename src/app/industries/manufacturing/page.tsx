...
import { manufacturingData } from "@/data/industries/manufacturing";

export const metadata: Metadata = {
  title: manufacturingData.title,
  description: manufacturingData.description,
};
    ...
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Streamline Manufacturing Back-Office Operations</h2>
