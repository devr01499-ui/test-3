...
import { nonProfitData } from "@/data/industries/non-profit";

export const metadata: Metadata = {
  title: nonProfitData.title,
  description: nonProfitData.description,
};

export default function NonProfitPage() {
  const data = nonProfitData;
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Scale Your Mission. Not Your Overhead.</h2>
