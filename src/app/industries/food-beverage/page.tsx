...
import { foodBeverageData } from "@/data/industries/food-beverage";

export const metadata: Metadata = {
  title: foodBeverageData.title,
  description: foodBeverageData.description,
};

export default function FoodBeveragePage() {
  const data = foodBeverageData;
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Serve Up Exceptional F&B Operations Today</h2>
