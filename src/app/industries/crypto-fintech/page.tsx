...
import { cryptoFintechData } from "@/data/industries/crypto-fintech";

export const metadata: Metadata = {
  title: cryptoFintechData.title,
  description: cryptoFintechData.description,
};

export default function CryptoFintechPage() {
  const data = cryptoFintechData;
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Build World-Class Compliant Crypto Operations</h2>
