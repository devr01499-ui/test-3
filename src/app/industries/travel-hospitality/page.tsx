...
import { travelHospitalityData } from "@/data/industries/travel-hospitality";

export const metadata: Metadata = {
  title: travelHospitalityData.title,
  description: travelHospitalityData.description,
};

export default function TravelHospitalityPage() {
  const data = travelHospitalityData;
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Ready to Elevate Your Guest Experience?</h2>
