...
import { utilitiesEnergyData } from "@/data/industries/utilities-energy";

export const metadata: Metadata = {
  title: utilitiesEnergyData.title,
  description: utilitiesEnergyData.description,
};

export default function UtilitiesEnergyPage() {
  const data = utilitiesEnergyData;
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Power Reliable Utility Customer Operations</h2>
