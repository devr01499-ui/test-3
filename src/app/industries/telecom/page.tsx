...
import { telecomData } from "@/data/industries/telecom";

export const metadata: Metadata = {
  title: telecomData.title,
  description: telecomData.description,
};

export default function TelecomPage() {
  const data = telecomData;
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Transform Your Subscriber Experience Today</h2>
