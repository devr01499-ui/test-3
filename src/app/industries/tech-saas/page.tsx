...
import { techSaasData } from "@/data/industries/tech-saas";

export const metadata: Metadata = {
  title: techSaasData.title,
  description: techSaasData.description,
};

export default function TechSaasPage() {
  const data = techSaasData;
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "6rem 0", background: "var(--primary)", color: "white" }}>
        <div className="container">
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "2rem" }}>Scale Your SaaS Without Scaling Overhead</h2>
